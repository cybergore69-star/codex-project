const INSIGHTS = [
  {
    id: "masalah-sebenar-ai-01",
    title: "Masalah Sebenar Bukan AI Akan Ambil Kerja Kita",
    tags: ["AI", "Future", "Work"],
    excerpt:
      "Masalah sebenar bukan AI akan ambil kerja kita, tetapi betapa cepatnya dunia berubah dan betapa ramai masih bergerak dengan cara lama.",
    body: [
